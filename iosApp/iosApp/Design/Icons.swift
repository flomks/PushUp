...
enum AppIcon: String {
    ...
    case figureJumpingJacks = "figure.jumprope"
    case figureSquat        = "figure.squat"
    case figureRunCircle    = "figure.run.circle.fill"
    case figureHighIntensity = "figure.highintensity.intervaltraining"
    case timer              = "timer"
    case clock              = "clock"
