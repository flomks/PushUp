...
import com.sinura.data.api.dto.DailyStatsDTO
import com.sinura.data.api.dto.MonthlyStatsDTO
import com.sinura.data.api.dto.SetUsernameRequest
import com.sinura.data.api.dto.StreakDTO
import com.sinura.data.api.dto.TotalStatsDTO
import com.sinura.data.api.dto.UsernameCheckResponse
import com.sinura.data.api.dto.WeeklyStatsDTO
...
class KtorApiClient(
    ...
    suspend fun setUsername(request: SetUsernameRequest): String = retrying {
        ...
        httpClient.patch("$backendBaseUrl/api/users/username") {
            ...
            .body<com.sinura.data.api.dto.SetUsernameResponse>()
            .username
    }
