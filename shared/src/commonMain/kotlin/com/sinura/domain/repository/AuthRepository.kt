 ...
 *
 * ## Error handling
 * All methods throw [com.sinura.domain.model.AuthException] subclasses on failure.
...
interface AuthRepository {
     ...
     * @throws com.sinura.domain.model.AuthException.EmailAlreadyInUse if the email is taken.
     * @throws com.sinura.domain.model.AuthException.WeakPassword if the password is too short.
     * @throws com.sinura.domain.model.AuthException.InvalidEmail if the email format is invalid.
     */
     ...
     * @throws com.sinura.domain.model.AuthException.InvalidCredentials if the credentials are wrong.
     */
     ...
     * @return The authenticated [User].
     * @throws com.sinura.domain.model.AuthException.InvalidCredentials if the token is invalid.
     */
     ...
     * @return The authenticated [User].
     * @throws com.sinura.domain.model.AuthException on failure.
     */
     ...
     * @throws com.sinura.domain.model.AuthException.NotAuthenticated if no refresh token is stored.
     * @throws com.sinura.domain.model.AuthException.SessionExpired if the refresh token is invalid or expired.
     */
