...
interface WorkoutSessionRepository {
     ...
     * @return Sessions with a non-[com.sinura.domain.model.SyncStatus.SYNCED] status.
     */
     ...
     * trigger ON DELETE CASCADE on child [com.sinura.domain.model.PushUpRecord] rows
