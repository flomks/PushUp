...
import com.sinura.data.api.dto.toCreateRequest
import com.sinura.data.api.isTransient
...
private fun com.sinura.domain.model.JoggingPlaybackEntry.normalizedForSync():
    com.sinura.domain.model.JoggingPlaybackEntry {
