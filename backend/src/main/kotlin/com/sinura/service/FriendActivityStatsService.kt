...
import com.sinura.dto.FriendActivityDayDTO
import com.sinura.dto.FriendActivityStatsDTO
import com.sinura.dto.FriendExerciseLevelDTO
import com.sinura.dto.FriendLevelDetailsDTO
import com.sinura.dto.FriendMonthlyActivityDTO
import com.sinura.dto.StatsPeriod
import com.sinura.plugins.ExerciseLevels
import com.sinura.plugins.FriendshipStatus
import com.sinura.plugins.Friendships
import com.sinura.plugins.JoggingSessions
import com.sinura.plugins.UserLevels
...
open class FriendActivityStatsService {
    ...
    open suspend fun getStats(
        ...
        val joggingDays: List<LocalDate> = com.sinura.plugins.JoggingSessions
            ...
            .where {
                (com.sinura.plugins.JoggingSessions.userId eq friendId) and
                com.sinura.plugins.JoggingSessions.endedAt.isNotNull()
            }
            .map { it[com.sinura.plugins.JoggingSessions.startedAtDay].atZone(ZoneOffset.UTC).toLocalDate() }
