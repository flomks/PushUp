...
import com.sinura.dto.ActivityDayDTO
import com.sinura.dto.ActivityMonthlyDTO
import com.sinura.dto.ActivityStreakDTO
...
class ActivityStatsService {
    ...
    suspend fun getActivityStreak(
        ...
        // Distinct dates from workout sessions (only sessions with actual activity)
